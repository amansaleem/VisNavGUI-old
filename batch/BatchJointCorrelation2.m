function popresCorr = BatchJointCorrelation2(batch2p,Fcoherence)
SetDirs;
if nargin < 1
...
popresCorr.Tsmthwin = 15;%250;%250;%150;%300;%40;%120;%50
popresCorr.TsmthwinDec = 250;%
popresCorr.Xsmthwin = 4;%2%1;%
popresCorr.SpdSmthWin = popresCorr.TsmthwinDec;
popresCorr.SpeedThreshold = 5;
popresCorr.nspeedbins = 5;
popresCorr.neyebins = 1;
popresCorr.nthetaphsbins = 1;%1;%
popresCorr.cellstr = 'goodonly';%'All_50bins';%'goodonly';%'goodonly_unwrapped';%'goodonly';%'All';%
filesuffix_EXP = ['Twin' num2str(popresCorr.Tsmthwin) '_' 'Xwin' num2str(popresCorr.Xsmthwin) '_' 'spdth' num2str(popresCorr.SpeedThreshold) '_' 'Decwin' num2str(popresCorr.TsmthwinDec) '_' num2str(popresCorr.nspeedbins) 'speedbins' '_' num2str(popresCorr.neyebins) 'eyebins' '_' num2str(popresCorr.nthetaphsbins) 'thetabins' '_' popresCorr.cellstr '_spdquantiles'];
disp(filesuffix_EXP);
