function popresCorr = BatchSpikeCorrelation(batch2p,Fcoherence)
SetDirs;
if nargin < 1
...
popresCorr.Tcorr = 250;
popresCorr.nbinscorr = 40;
popresCorr.Xsmthwin = 4;%2%1;%
popresCorr.SpdSmthWin = popresCorr.Tcorr;%popresCorr.Tsmthwin;
    ...
    for iseries = 1:numel(expt(ianimal).series)
        ...
        if exist([dDIRname filesep 'EXP_' filesuffix_EXP '.mat'],'file')
            if (expt(ianimal).goodCA1{iseries} == 1) && (expt(ianimal).goodV1{iseries} == 1)
                ...
                ncells = size(EXP.data.es.spikeTrain,2);
                PosError0{1} = EXP.data.es.spikeTrain;%EXP.Bayes.Posterior0{1};%getCircularAverage(EXP.Bayes.PosError0{1}',0,1);%EXP.Bayes.PosError0{1}
                PosError0{2} = EXP.data.es.spikeTrain;%EXP.Bayes.Posterior0{2};%getCircularAverage(EXP.Bayes.PosError0{2}',0,1);%EXP.Bayes.PosError0{2}
                sampleRate = mean(1./EXP.data.es.sampleSize);
                for icell = 1:ncells
                    PosError0{1}(:,icell) = smthInTime(PosError0{1}(:,icell), sampleRate, popresCorr.Tcorr, 'same', [], 'boxcarsum_centered');%popresCorr.Tsmthwin, 'same', [], 'boxcarsum_centered');
                end
...
%                 end
                ...
                fieldZ = EXP.CellInfo.fieldZ{cbase,gbase,rbase,obase};
                ...
                for g = [2 1 3 4]%2%
                    if gooddecCA1(g) && gooddecV1(g)
                        ...
                        maxX = 100;
                        X = getBayesVar(EXP.data.es.trajPercent,0,popresCorr.sampleRate, popresCorr.Tcorr,'boxcar_centered',EXP.data.es.CircularMaze,maxX);
                        [Xbinned, ~] = normalise1var(X, popresCorr.nXbins,[],[0 maxX]);
%                         Xbinned = floor(((EXP.Bayes.X-1)/Xrange)*popresCorr.nXbins)+1;%
                ...
                for g = [2 1 3 4]%2%
                    if gooddecCA1(g) && gooddecV1(g)
                        ...
                        CA1cells = EXP.CellInfo.Goodcluster & ~EXP.CellInfo.Finterneuron & fieldZ >= 2 & EXP.CellInfo.Probe == 1;
                        V1cells = EXP.CellInfo.Goodcluster & ~EXP.CellInfo.Finterneuron & fieldZ >= 2 & EXP.CellInfo.Probe == 2;
                        [fposCA1,isortCA1] = sort(EXP.CellInfo.fieldPos{cbase,gbase,rbase,obase}(CA1cells));
                        [fposV1,isortV1] = sort(EXP.CellInfo.fieldPos{cbase,gbase,rbase,obase}(V1cells));
                        
                        popresCorr.s_fposCA1{ianimal,iseries,g} = fposCA1;
                        popresCorr.s_fposV1{ianimal,iseries,g} = fposV1;
                        fieldnorm = EXP.CellInfo.field{cbase,gbase,rbase,obase};
                        ...
                        popresCorr.s_CA1V1fieldcorrCA1{ianimal,iseries,g} = fieldnorm(CA1cells,:)*(fieldnorm(CA1cells,:)')/size(fieldnorm,2);
                        popresCorr.s_CA1V1fieldcorrCA1{ianimal,iseries,g} = popresCorr.s_CA1V1fieldcorrCA1{ianimal,iseries,g}(isortCA1,isortCA1);
                        popresCorr.s_CA1V1fieldcorrV1{ianimal,iseries,g} = fieldnorm(V1cells,:)*(fieldnorm(V1cells,:)')/size(fieldnorm,2);
                        popresCorr.s_CA1V1fieldcorrV1{ianimal,iseries,g} = popresCorr.s_CA1V1fieldcorrV1{ianimal,iseries,g}(isortV1,isortV1);
                        popresCorr.s_CA1V1fieldcorrCA1V1{ianimal,iseries,g} = fieldnorm(CA1cells,:)*(fieldnorm(V1cells,:)')/size(fieldnorm,2);
                        popresCorr.s_CA1V1fieldcorrCA1V1{ianimal,iseries,g} = popresCorr.s_CA1V1fieldcorrCA1V1{ianimal,iseries,g}(isortCA1,isortV1);
                                                
                        popresCorr.s_CA1V1CrossCA1{ianimal,iseries,g} = popresCorr.s_CA1V1Cross{ianimal,iseries,g}(CA1cells,CA1cells);
                        popresCorr.s_CA1V1CrossCA1{ianimal,iseries,g} = popresCorr.s_CA1V1CrossCA1{ianimal,iseries,g}(isortCA1,isortCA1);
                        popresCorr.s_CA1V1CrossCA1{ianimal,iseries,g}(logical(eye(size(popresCorr.s_CA1V1CrossCA1{ianimal,iseries,g})))) = NaN;
                        popresCorr.s_CA1V1CrossV1{ianimal,iseries,g} = popresCorr.s_CA1V1Cross{ianimal,iseries,g}(V1cells,V1cells);
                        popresCorr.s_CA1V1CrossV1{ianimal,iseries,g} = popresCorr.s_CA1V1CrossV1{ianimal,iseries,g}(isortV1,isortV1);
                        popresCorr.s_CA1V1CrossV1{ianimal,iseries,g}(logical(eye(size(popresCorr.s_CA1V1CrossV1{ianimal,iseries,g})))) = NaN;
                        popresCorr.s_CA1V1CrossCA1V1{ianimal,iseries,g} = popresCorr.s_CA1V1Cross{ianimal,iseries,g}(CA1cells,V1cells);
                        popresCorr.s_CA1V1CrossCA1V1{ianimal,iseries,g} = popresCorr.s_CA1V1CrossCA1V1{ianimal,iseries,g}(isortCA1,isortV1);
                        popresCorr.s_CA1V1CrossCA1V1{ianimal,iseries,g}(logical(eye(size(popresCorr.s_CA1V1CrossCA1V1{ianimal,iseries,g})))) = NaN;
                        
                        popresCorr.s_CA1V1CrossCA1_shuffled{ianimal,iseries,g} = popresCorr.s_CA1V1Cross_shuffled{ianimal,iseries,g}(CA1cells,CA1cells);
                        popresCorr.s_CA1V1CrossCA1_shuffled{ianimal,iseries,g} = popresCorr.s_CA1V1CrossCA1_shuffled{ianimal,iseries,g}(isortCA1,isortCA1);
                        popresCorr.s_CA1V1CrossCA1_shuffled{ianimal,iseries,g}(logical(eye(size(popresCorr.s_CA1V1CrossCA1_shuffled{ianimal,iseries,g})))) = NaN;
                        popresCorr.s_CA1V1CrossV1_shuffled{ianimal,iseries,g} = popresCorr.s_CA1V1Cross_shuffled{ianimal,iseries,g}(V1cells,V1cells);
                        popresCorr.s_CA1V1CrossV1_shuffled{ianimal,iseries,g} = popresCorr.s_CA1V1CrossV1_shuffled{ianimal,iseries,g}(isortV1,isortV1);
                        popresCorr.s_CA1V1CrossV1_shuffled{ianimal,iseries,g}(logical(eye(size(popresCorr.s_CA1V1CrossV1_shuffled{ianimal,iseries,g})))) = NaN;
                        popresCorr.s_CA1V1CrossCA1V1_shuffled{ianimal,iseries,g} = popresCorr.s_CA1V1Cross_shuffled{ianimal,iseries,g}(CA1cells,V1cells);
                        popresCorr.s_CA1V1CrossCA1V1_shuffled{ianimal,iseries,g} = popresCorr.s_CA1V1CrossCA1V1_shuffled{ianimal,iseries,g}(isortCA1,isortV1);
                        popresCorr.s_CA1V1CrossCA1V1_shuffled{ianimal,iseries,g}(logical(eye(size(popresCorr.s_CA1V1CrossCA1V1_shuffled{ianimal,iseries,g})))) = NaN;
                        
                        valid = ~isnan(popresCorr.s_CA1V1fieldcorrCA1V1{ianimal,iseries,g}(:)) & ~isnan(popresCorr.s_CA1V1CrossCA1V1{ianimal,iseries,g}(:));
                        fieldcorr = popresCorr.s_CA1V1fieldcorrCA1V1{ianimal,iseries,g}(valid);
                        fieldcorr(fieldcorr==min(fieldcorr(:))) = -1;
                        fieldcorr(fieldcorr==max(fieldcorr(:))) = 1;
                        fieldcorr = normalise1var(fieldcorr, popresCorr.nbinscorr, [], [-1 1]);
                        noisecorr = popresCorr.s_CA1V1CrossCA1V1{ianimal,iseries,g}(valid);
                        noisecorr_shuffled = popresCorr.s_CA1V1CrossCA1V1_shuffled{ianimal,iseries,g}(valid);
                        popresCorr.s_CA1V1CrossAveCA1V1{ianimal,iseries,g} = fast1Dmap(fieldcorr+1,noisecorr,1,1,popresCorr.nbinscorr/2,false);
                        popresCorr.s_CA1V1CrossAveCA1V1_shuffled{ianimal,iseries,g} = fast1Dmap(fieldcorr+1,noisecorr_shuffled,1,1,popresCorr.nbinscorr/2,false);
                    end
                end
...
for g = [2 1 3 4]
    count = 0;
    popresCorr.CA1V1CrossCA1V1{g} = cell(nbXbins,nbXbins);
    popresCorr.CA1V1CrossCA1{g} = cell(nbXbins,nbXbins);
    popresCorr.CA1V1CrossV1{g} = cell(nbXbins,nbXbins);
    popresCorr.CA1V1CrossCA1V1_shuffled{g} = cell(nbXbins,nbXbins);
    popresCorr.CA1V1CrossCA1_shuffled{g} = cell(nbXbins,nbXbins);
    popresCorr.CA1V1CrossV1_shuffled{g} = cell(nbXbins,nbXbins);
    popresCorr.CA1V1CrossAveCA1V1{g} = [];
    popresCorr.CA1V1CrossAveCA1V1_shuffled{g} = [];
    popresCorr.CA1V1CrossAveCA1V1_SE{g} = [];
    popresCorr.CA1V1CrossAveCA1V1_shuffled_SE{g} = [];
    if Fcoherence
        ...
        for iseries = 1:size(popresCorr.s_CA1V1Cov,2)
            if ~isempty(popresCorr.s_CA1V1Cov{ianimal,iseries,g})
               if sum(isnan(popresCorr.s_CA1V1Cov{ianimal,iseries,g}(:))) == 0
                   fposCA1 = popresCorr.s_fposCA1{ianimal,iseries,g};
                   fposV1 = popresCorr.s_fposV1{ianimal,iseries,g};
                   for i=1:nbXbins
                       for j=1:nbXbins
                           mtemp = popresCorr.s_CA1V1CrossCA1{ianimal,iseries,g}(fposCA1>=(i-1)*10+1 & fposCA1<=i*10,fposCA1>=(j-1)*10+1 & fposCA1<=j*10);
                           popresCorr.CA1V1CrossCA1{g}{i,j} = cat(1,popresCorr.CA1V1CrossCA1{g}{i,j},mtemp(:));
                           mtemp = popresCorr.s_CA1V1CrossV1{ianimal,iseries,g}(fposV1>=(i-1)*10+1 & fposV1<=i*10,fposV1>=(j-1)*10+1 & fposV1<=j*10);
                           popresCorr.CA1V1CrossV1{g}{i,j} = cat(1,popresCorr.CA1V1CrossV1{g}{i,j},mtemp(:));
                           mtemp = popresCorr.s_CA1V1CrossCA1V1{ianimal,iseries,g}(fposCA1>=(i-1)*10+1 & fposCA1<=i*10,fposV1>=(j-1)*10+1 & fposV1<=j*10);
                           popresCorr.CA1V1CrossCA1V1{g}{i,j} = cat(1,popresCorr.CA1V1CrossCA1V1{g}{i,j},mtemp(:));
                           
                           mtemp = popresCorr.s_CA1V1CrossCA1_shuffled{ianimal,iseries,g}(fposCA1>=(i-1)*10+1 & fposCA1<=i*10,fposCA1>=(j-1)*10+1 & fposCA1<=j*10);
                           popresCorr.CA1V1CrossCA1_shuffled{g}{i,j} = cat(1,popresCorr.CA1V1CrossCA1_shuffled{g}{i,j},mtemp(:));
                           mtemp = popresCorr.s_CA1V1CrossV1_shuffled{ianimal,iseries,g}(fposV1>=(i-1)*10+1 & fposV1<=i*10,fposV1>=(j-1)*10+1 & fposV1<=j*10);
                           popresCorr.CA1V1CrossV1_shuffled{g}{i,j} = cat(1,popresCorr.CA1V1CrossV1_shuffled{g}{i,j},mtemp(:));
                           mtemp = popresCorr.s_CA1V1CrossCA1V1_shuffled{ianimal,iseries,g}(fposCA1>=(i-1)*10+1 & fposCA1<=i*10,fposV1>=(j-1)*10+1 & fposV1<=j*10);
                           popresCorr.CA1V1CrossCA1V1_shuffled{g}{i,j} = cat(1,popresCorr.CA1V1CrossCA1V1_shuffled{g}{i,j},mtemp(:));                                   
                       end
                   end
                   popresCorr.CA1V1CrossAveCA1V1{g} = cat(2,popresCorr.CA1V1CrossAveCA1V1{g},popresCorr.s_CA1V1CrossAveCA1V1{ianimal,iseries,g});
                   popresCorr.CA1V1CrossAveCA1V1_shuffled{g} = cat(2,popresCorr.CA1V1CrossAveCA1V1_shuffled{g},popresCorr.s_CA1V1CrossAveCA1V1_shuffled{ianimal,iseries,g});
    ...
    for i=1:nbXbins
        for j=1:nbXbins
            popresCorr.CA1V1CrossCA1{g}{i,j} = nanmean(popresCorr.CA1V1CrossCA1{g}{i,j},1);
            popresCorr.CA1V1CrossV1{g}{i,j} = nanmean(popresCorr.CA1V1CrossV1{g}{i,j},1);
            popresCorr.CA1V1CrossCA1V1{g}{i,j} = nanmean(popresCorr.CA1V1CrossCA1V1{g}{i,j},1);
            
            popresCorr.CA1V1CrossCA1_shuffled{g}{i,j} = nanmean(popresCorr.CA1V1CrossCA1_shuffled{g}{i,j},1);
            popresCorr.CA1V1CrossV1_shuffled{g}{i,j} = nanmean(popresCorr.CA1V1CrossV1_shuffled{g}{i,j},1);
            popresCorr.CA1V1CrossCA1V1_shuffled{g}{i,j} = nanmean(popresCorr.CA1V1CrossCA1V1_shuffled{g}{i,j},1);
        end
    end
    popresCorr.CA1V1CrossCA1{g} = cell2mat(popresCorr.CA1V1CrossCA1{g});
    popresCorr.CA1V1CrossV1{g} = cell2mat(popresCorr.CA1V1CrossV1{g});
    popresCorr.CA1V1CrossCA1V1{g} = cell2mat(popresCorr.CA1V1CrossCA1V1{g});
    
    popresCorr.CA1V1CrossCA1_shuffled{g} = cell2mat(popresCorr.CA1V1CrossCA1_shuffled{g});
    popresCorr.CA1V1CrossV1_shuffled{g} = cell2mat(popresCorr.CA1V1CrossV1_shuffled{g});
    popresCorr.CA1V1CrossCA1V1_shuffled{g} = cell2mat(popresCorr.CA1V1CrossCA1V1_shuffled{g});
    
    CrossAve = nanmean(popresCorr.CA1V1CrossAveCA1V1{g},2);
    CrossAve_shuffled = nanmean(popresCorr.CA1V1CrossAveCA1V1_shuffled{g},2);
    kfold = size(popresCorr.CA1V1CrossAveCA1V1{g},2);
    allsessions = 1:size(popresCorr.CA1V1CrossAveCA1V1{g},2);
    CrossAve_std = 0;
    CrossAve_shuffled_std = 0;
    for k = 1:kfold
        CrossAve_iter = nanmean(popresCorr.CA1V1CrossAveCA1V1{g}(:,~ismember(allsessions,k)),2);
        CrossAve_shuffled_iter = nanmean(popresCorr.CA1V1CrossAveCA1V1_shuffled{g}(:,~ismember(allsessions,k)),2);
        CrossAve_std = CrossAve_std + (kfold - 1)/kfold*(CrossAve_iter - CrossAve).^2;
        CrossAve_shuffled_std = CrossAve_shuffled_std + (kfold - 1)/kfold*(CrossAve_shuffled_iter - CrossAve_shuffled).^2;
    end
    popresCorr.CA1V1CrossAveCA1V1_SE{g} = sqrt(CrossAve_std);
    popresCorr.CA1V1CrossAveCA1V1_shuffled_SE{g} = sqrt(CrossAve_shuffled_std);
    popresCorr.CA1V1CrossAveCA1V1{g} = CrossAve;
    popresCorr.CA1V1CrossAveCA1V1_shuffled{g} = CrossAve_shuffled;
